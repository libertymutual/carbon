...
#if RCT_DEV
import React.RCTDevLoadingView
#endif
...
final public class ReactNativeView: View {
    ...
    public func loadViewController(config: ViewConfig) -> UIViewController {
        ...
        // Solution for https://github.com/facebook/react-native/issues/16376
        #if RCT_DEV
            ReactNativeView.bridge!.module(for: RCTDevLoadingView.class)
        #endif
